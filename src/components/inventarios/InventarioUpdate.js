import React, { useState, useEffect } from 'react' // hooks useState guardar la respuesta del servicio, consulto el inventario por su id 
import { useParams } from 'react-router-dom'; // y useEffect para encapsular el servicio para que se llame al cargar el component
