...
import { getTipoEquipoId, editTipoEquipo } from '../../services/tipoService';
...
export const TipoUpdate = () => {
    ...
    const getTipo = async () => {
        try {
            ...
            swal.showLoading();
            const { data } = await getTipoEquipoId(tipoEquipoId);
            console.log(data);
            setTipos(data) // se le agrega la data a inventario
            swal.close()
        } catch (error) {
            console.log(error);
            swal.close()
    ...
    const handleOnSubmit = async (e) => { // ESTEEEEEEEEEEEE
        ...
        try {
            ...
            const { data } = await editTipoEquipo(tipoEquipoId, tipoUpdate)
            console.log(data);
            swal.close();
